...
export default function EmployeeTable({ employees }) {
  ...
  useEffect(() => {
    const foundEmployees = localEmployees.filter((user) =>
      user.name.last.toLowerCase().includes(term, localEmployees)
    );
